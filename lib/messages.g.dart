...
class PubKeyCredParamType {
  ...
  static PubKeyCredParamType decode(Object result) {
    result as List<Object?>;
...
class AuthenticatorSelectionType {
  ...
  static AuthenticatorSelectionType decode(Object result) {
    result as List<Object?>;
    return AuthenticatorSelectionType(
      requireResidentKey: result[0]! as bool,
      residentKey: result[1]! as String,
      userVerification: result[2]! as String,
...
class _PasskeysApiCodec extends StandardMessageCodec {
  ...
  void writeValue(WriteBuffer buffer, Object? value) {
    ...
    } else if (value is AuthenticatorSelectionType) {
      buffer.putUint8(129);
      writeValue(buffer, value.encode());
    } else if (value is PubKeyCredParamType) {
      buffer.putUint8(130);
      writeValue(buffer, value.encode());
  ...
  Object? readValueOfType(int type, ReadBuffer buffer) {
    switch (type) {
      ...
      case 129: 
        return AuthenticatorSelectionType.decode(readValue(buffer)!);
      case 130: 
        return PubKeyCredParamType.decode(readValue(buffer)!);
      case 131: 
...
class PasskeysApi {
  ...
  Future<RegisterResponse> register(String arg_challenge, RelyingParty arg_relyingParty, User arg_user, List<String?> arg_excludeCredentialIDs, List<PubKeyCredParamType?>? arg_pubKeyCredParams, AuthenticatorSelectionType arg_authenticatorSelectionType) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.passkeys_ios.PasskeysApi.register', codec,
        binaryMessenger: _binaryMessenger);
    final List<Object?>? replyList =
        await channel.send(<Object?>[arg_challenge, arg_relyingParty, arg_user, arg_excludeCredentialIDs, arg_pubKeyCredParams, arg_authenticatorSelectionType]) as List<Object?>?;
    if (replyList == null) {
      throw PlatformException(
        code: 'channel-error',
        message: 'Unable to establish connection on channel.',
